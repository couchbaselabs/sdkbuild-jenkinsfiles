...
::memcached bucket
call packages\sdkdclient\bin\brun.bat --bucket-password="" --testsuite-test="Rb1Swap" --bucket-type="memcached" --rebound 240 -A S3Creds_tmp -I cluster_config.ini -I sdkd-sync.args --testsuite-variants "MEMD" -d all:debug --install-skip false --install-version %cluster_version% --install-url %url% --cluster-useSSL=%useSSL%
call packages\sdkdclient\bin\brun.bat --bucket-password="" --testsuite-test="passthrough" --bucket-type="memcached" --rebound 240 -A S3Creds_tmp -I cluster_config.ini -I sdkd-sync.args --testsuite-variants "MEMD" -d all:debug --install-skip false --install-version %cluster_version% --install-url %url% --cluster-useSSL=%useSSL%

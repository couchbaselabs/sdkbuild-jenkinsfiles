...
git clone http://Oferya:oferhub11@github.com/couchbase/couchbase-net-client.git
...
copy C:\bin\SdkdConsoleAsync.bat %SDKDCLIENT-NG%

echo ===============================================================brun

cd %SDKDCLIENT-NG%
echo -C 'share\rexec' --rexec_path 'SdkdConsoleAsync.bat' --rexec_port 8050 > sdkd-async.args




call packages\sdkdclient\bin\brun.bat --bucket-password="" --rebound %rebound% -A S3Creds_tmp -I cluster_config.ini -I sdkd-async.args --testsuite-variants "HYBRID" --install-skip false --install-version %cluster_version% --install-url %url% -d all:debug --cluster-useSSL=%useSSL%

            ...
            parallel {
                ...
                stage('amzn2 x86_64') {
                    ...
                    stages {
                        ...
                        stage('srpm') {
                            steps {
                                package_srpm("amzn", 64, 2, "x86_64", "amazonlinux-2-x86_64", VERSION)
                            }
                        }
                        stage('rpm') {
                            steps {
                                package_rpm("amzn", 64, 2, "x86_64", "amazonlinux-2-x86_64", VERSION)
                            }
                        }
                    }
                }
                ...
                stage('ubuntu2204 amd64') {
                    ...
                    stages {
                        ...
                        stage('src') {
                            steps {
                                package_src("ubuntu2204", "amd64", "jammy", VERSION)
                            }
                        }
                        stage('deb') {
                            steps {
                ...
                stage('debian11 amd64') {
                    ...
                    stages {
                        ...
                        stage('src') {
                            steps {
                                package_src("debian11", "amd64", "bullseye", VERSION)
                            }
                        }
                        stage('deb') {
                            steps {

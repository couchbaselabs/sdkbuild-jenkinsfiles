        ...
        stage('inst') {
            matrix {
                axes {
                    axis {
                        name 'PLATFORM'
                        values 'centos7', 'macos-11.0', 'macos-10.15', 'ubuntu20', 'debian9', 'm1', 'alpine', 'amzn2', 'qe-grav2-amzn2', 'qe-ubuntu20-arm64'
                    }
                    axis {
                        name 'CB_RUBY_VERSION'
                        values '2.7', '3.0', '3.1', '3.2', 'brew'
        ...
        stage('test') {
            ...
            matrix {
                axes {
                    axis {
                        name 'CB_VERSION'
                        values '7.2-stable', '7.1-stable', '7.1-release', '7.0-release', '6.6-release'
                    }
                    axis {
                        name 'CB_RUBY_VERSION'

    ...
    stages {
        ...
        stage('package') {
            ...
            environment {
                ...
                PATH="${WORKSPACE}/python${DEFAULT_PY_VERSION}:${WORKSPACE}/python${DEFAULT_PY_VERSION}/bin:$PATH"
            }
            steps {
                cleanWs()
                ...
                echo "My path:${PATH}"
                shWithEcho("""
export PATH=${WORKSPACE}/python${DEFAULT_PY_VERSION}:${WORKSPACE}/python${DEFAULT_PY_VERSION}/bin:${PATH}
echo "Path:${PATH}"
echo "Pip is:"
echo `which pip`

...
$CBCI_EXPECTED = @{
    ...
    'tasks.sh'            = '87b9b74590b1e4780dc4943bb26543bbdd3071ecd952184483bee920245fa063'
    ...
    'ci-config.yaml'      = '14a48e577b45837e7cb7bee9603435cba863977e7a452d280fdd06f4e45e8b85'
}

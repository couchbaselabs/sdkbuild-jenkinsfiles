...
get_expected_hash() {
    ...
    case "${name}" in
        ...
        "tasks.sh")            echo "ba9363e3ba8afccc9fbb56d0880aa9a9718b521857ed3a6ac832ad383c5a0795" ;;
        "tasks.ps1")           echo "1e02efd929308115296609201564d9d15d5761d4b37b46da770b4d5e46fe7dba" ;;

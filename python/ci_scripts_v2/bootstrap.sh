...
get_expected_hash() {
    ...
    case "${name}" in
        ...
        "tasks.sh")            echo "09af6f52ef4aaab6028a3a415f5e3fc4956aef9d0e91ee0db2c602a6ae450735" ;;
        "tasks.ps1")           echo "37655178162ccfd6b20467cc6286208be0ef6c209252a8c2c99b43d69d04ba6d" ;;

...
get_expected_hash() {
    ...
    case "${name}" in
        ...
        "tasks.sh")            echo "1971fa78f4b857fa816aa297ec5044adeeb94f57acd789946aaccd4350399b1d" ;;
        "tasks.ps1")           echo "0a058c057d6f91ca23ff6cb88cb199d1c6be24bf406959a6808c76789ed5186b" ;;

...
get_expected_hash() {
    ...
    case "${name}" in
        ...
        "tasks.sh")           echo "6031cd0fa23dfe1ecbe23fe219e841bc26f4a20b40199dd919e738737d9ff20c" ;;
        "tasks.ps1")          echo "bef11d70fdb271668c2a288bf6d268d63ba33053fd980e1abdbb44f2921c7dc3" ;;

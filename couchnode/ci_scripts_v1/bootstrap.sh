...
get_expected_hash() {
    ...
    case "${name}" in
        ...
        "tasks.sh")           echo "938fbff22bb39afb7533768663fdadb266d44596b05d9872bc7938afaa112d10" ;;
        "tasks.ps1")          echo "84416ee4eac2f6ac57a1c682715844509ec6905d9ffa26ad9e572b99bab8422d" ;;

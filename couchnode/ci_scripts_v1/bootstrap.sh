...
get_expected_hash() {
    ...
    case "${name}" in
        ...
        "tasks.sh")           echo "8bcc1fb2b9fc5360c7363fadff7c4ebb97115601242b5c389e0fb9a17f7000c5" ;;
        "tasks.ps1")          echo "066a0a4ec7cece71f776b343770e79ff4d856ac5663e4487ff6f159f92a7192c" ;;
